    ...
    render(){
        ...
        return(
            <ImageBackground style={styles.header} source={require('../images/headerBg.jpg')}>
                    <TouchableOpacity style={{height:'100%',justifyContent:"center", position: 'absolute',left: pxToDp(0),top:Platform.OS==='android'?0:pxToDp(40),}} onPress={() => goBack()}>
                        <Image style={styles.headerBack} source={require('../images/closeWhite.png')}></Image>
                    </TouchableOpacity>
